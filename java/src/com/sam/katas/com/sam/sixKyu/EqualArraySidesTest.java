...
class EqualArraySidesTest {

	@Test
	public void test() {
		assertEquals(3, EqualArraySides.findEvenIndex(new int[] { 1, 2, 3, 4, 3, 2, 1 }));
		assertEquals(1, EqualArraySides.findEvenIndex(new int[] { 1, 100, 50, -51, 1, 1 }));
		assertEquals(-1, EqualArraySides.findEvenIndex(new int[] { 1, 2, 3, 4, 5, 6 }));
		assertEquals(3, EqualArraySides.findEvenIndex(new int[] { 20, 10, 30, 10, 10, 15, 35 }));
